...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AlivcSmartVideo/AlivcSmartVideo.bundle"
  install_resource "${PODS_ROOT}/AliyunVideoSDKPro/AliyunVideoSDKPro.bundle"
  install_resource "${PODS_ROOT}/MJRefresh/MJRefresh.framework/MJRefresh.bundle"
  install_resource "${PODS_ROOT}/Nama-lite/FaceUnity-SDK-iOS-lite/release_note.txt"
  install_resource "${PODS_ROOT}/Nama-lite/FaceUnity-SDK-iOS-lite/Resources/anim_model.bundle"
  install_resource "${PODS_ROOT}/Nama-lite/FaceUnity-SDK-iOS-lite/Resources/ardata_ex.bundle"
  install_resource "${PODS_ROOT}/Nama-lite/FaceUnity-SDK-iOS-lite/Resources/face_beautification.bundle"
  install_resource "${PODS_ROOT}/Nama-lite/FaceUnity-SDK-iOS-lite/Resources/fxaa.bundle"
  install_resource "${PODS_ROOT}/Nama-lite/FaceUnity-SDK-iOS-lite/Resources/v3.bundle"
fi
